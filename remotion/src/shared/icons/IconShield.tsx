...
export const IconShield: React.FC<IconProps> = ({ size = 64, color = theme.semantic.threat, style }) => {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
            ...
            {/* Inner check or lock symbol could vary, keeping it clean shield for 'Protect' */}
